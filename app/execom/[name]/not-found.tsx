...
export default function ExecomMemberNotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-black px-6 text-center">
      ...
      <Link 
        href="/execom"
        className="mt-8 inline-flex h-10 items-center justify-center rounded-full bg-[#D4AF37] px-6 text-sm font-medium text-black transition-colors hover:bg-[#c9a02f]"
      >
