    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          <Calendar className="w-3.5 h-3.5 text-[#8B93A6]" />
          <time className="text-xs font-mono text-[#8B93A6] tracking-wider">
        ...
        {/* Description */}
        <p className="text-sm text-[#8B93A6] line-clamp-2 mb-4">
