...
export default function SocialLinks({ member }: { member: ExecomMember }) {
  ...
  const linkClass =
    'group flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] text-white/60 transition-all duration-300 hover:scale-110 hover:border-white/50 hover:text-white hover:shadow-[0_0_20px_rgba(255,255,255,0.25)]';
